...
OUTPUT;
  ...
  /** @test */
  public function media2version_method_adds_nmedias_record_for_the_given_media_and_note_ids_and_version()
  {
    $cf        = $this->getClassCfg();
    $user_mock = $this->initAndMockUserClass();
    ...
    $this->assertTrue(
      $this->note->media2version($this->id_media, $this->id_note, 4)
    );
  }

  /** @test */
  public function media2version_method_adds_nmedias_record_for_the_given_media_and_note_ids_and_version_is_not_provided()
  {
    $cf        = $this->getClassCfg();
    $user_mock = $this->initAndMockUserClass();
    ...
    $this->assertTrue(
      $this->note->media2version($this->id_media, $this->id_note)
    );
  }

  /** @test */
  public function media2version_method_returns_false_when_the_provided_media_id_is_empty()
  {
    $this->assertFalse(
      $this->note->media2version('', $this->id_note)
    );
  }

 /** @test */
  public function media2version_method_returns_false_when_the_provided_media_id_does_not_exists()
  {
    $cf = $this->getClassCfg();
  ...
  /** @test */
  public function media2version_method_returns_false_when_the_provided_note_id_does_not_exists()
  {
    $cf = $this->getClassCfg();
  ...
  /** @test */
  public function media2version_method_returns_false_when_inserting_to_nmedias_fails()
  {
    $cf        = $this->getClassCfg();
    $user_mock = $this->initAndMockUserClass();
