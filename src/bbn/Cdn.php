...
';
   ...
   * @return bool
   */
  public function checkCache($real = true)
  {
   ...
   * @return string
   */
  protected function jsMask(string $code): string
  {
...
JS;
   ...
   * @return string
   */
  protected function getJs(array $codes, $encapsulated = true): string
  {
    $code = '';
    if (!empty($codes['js'])) {
      $num      = count($codes['js']);
...
JS;
   ...
   * @return string
   */
  protected function getCss(array $codes)
  {
    $code = '';
    if (!empty($codes['css'])) {
