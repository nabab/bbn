...
class Builder
{
  ...
  public static function giveId(array &$cfg){
    if ( !isset($cfg['attr']) ){
      $cfg['attr'] = [];
    }
  ...
  public function labelInput($cfg, $force=false)
  {
  ...
  public function centralInput($cfg, $force=false)
  {
  ...
  public function fakeLabel(array $cfg, $force=false)
  {
  ...
  public function labelButton($cfg, $force=false){
