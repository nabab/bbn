...
class Option extends DbCls
{
  ...
  use Option\Internal\Cfg;
  use Option\Internal\Code;
  use Option\Internal\I18n;
  use Option\Internal\Indexed;
  use Option\Internal\Manip;
  use Option\Internal\Native;
  use Option\Internal\Options;
  use Option\Internal\Parents;
  use Option\Internal\Path;
  use Option\Internal\Permission;
  use Option\Internal\Plugin;
  use Option\Internal\Prop;
  use Option\Internal\Ref;
  use Option\Internal\Root;
  use Option\Internal\Single;
  use Option\Internal\Sub;
  use Option\Internal\Template;
  use Option\Internal\Tree;
  use Option\Internal\Write;
