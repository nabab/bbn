...
class txt
{
   ...
   *
   * <code>
   * \bbn\txt::change_case('TEST CASE', 'lower')); //Returns "test case"
   * \bbn\txt::change_case('test case', 'upper')); //Returns "TEST CASE"
   * \bbn\txt::change_case('test case')); //Returns "Test Case"
   * </code>
   *
   ...
   *
   * <code>
   * \bbn\txt::escape_dquotes('L\'infanzia di "Maria"'); //Returns "L'infanzia di \"Maria\""
   * </code>
   *
   ...
   *
   * <code>
   * \bbn\txt::escape_dquote('L\'infanzia di "Maria"'); //Returns "L'infanzia di \"Maria\""
   * </code>
   *
   * @param string $st The string to escape.
   *
   ...
   *
   * <code>
   * \bbn\txt::escape_quote('L\'infanzia di "Maria"'); //Returns "L'infanzia di \"Maria\""
   * </code>
   *
   * @param string $st The string to escape.
   *
   ...
   *
   * <code>
   * \bbn\txt::escape_quotes('L\'infanzia di "Maria"'); //Returns "L'infanzia di \"Maria\""
   * </code>
   *
   * @param string $st The string to escape.
   *
   ...
   *
   * <code>
   * \bbn\txt::escape_squotes("L'infanzia di \"maria\""); //Returns "L\'infanzia di "maria""
   * </code>
   *
   * @param string $st The string to escape.
   *
   ...
   *
   * <code>
   * \bbn\txt::escape("L'infanzia di \"maria\""); //Returns "L\'infanzia di "maria""
   * </code>
   *
   * @param string $st The string to escape.
   *
   ...
   *
   * <code>
   * \bbn\txt::escape_apo("L'infanzia di \"maria\""); //Returns "L\'infanzia di "maria""
   * </code>
   *
   * @param string $st The string to escape.
   *
   ...
   *
   * <code>
   * \bbn\txt::escape_squote("L'infanzia di \"maria\""); //Returns "L\'infanzia di "maria""
   * </code>
   *
   * @param string $st The string to escape.
   *
   ...
   *
   * <code>
   * \bbn\txt::cut("<!-- HTML Document --> Example text", 7); //Returns "Example..."
   * </code>
   *
   ...
   *
   * <code>
   * \bbn\txt::encode_filename('test file/,1', 15, 'txt'); //Returns
"test_file_1.txt"
   * </code>
   *
   ...
   *
   * <code>
   * \bbn\txt::encode_dbname('my.database_name ? test  :,; !plus'); //Returns  "my_database_name_test_plus"
   * </code>
   *
   * @param string $st The name as string.
   ...
   *
   * <code>
   * \bbn\txt::file_ext('d:\test.txt'); //Returns "txt"
   * \bbn\txt::file_ext('d:\test.txt', 1); //Returns ['d:\\a', 'txt']
   * </code>
   *
   ...
   *
   * <code>
   * \bbn\txt::genpwd(); //Returns "khc9P871w"
   * \bbn\txt::genpwd(6, 4); //Returns "dDEtxY"
   * </code>
   *
   ...
   *
   * <code>
   * \bbn\txt::is_json('{"firstName": "John", "lastName": "Smith", "age": 25}'); //Returns true
   * </code>
   *
   ...
   *
   * <code>
   * \bbn\txt::is_number([1, 2]); //Returns false
   * \bbn\txt::is_number(150); //Returns true
   * \bbn\txt::is_number('150'); //Returns true
   * </code>
   *
   ...
   *
	 ...
	 *
	 * <code>
	 * \bbn\txt::is_integer(13.2); //Returns false
	 * \bbn\txt::is_integer(14); //Returns true
	 * \bbn\txt::is_integer('14'); //Returns true
	 * </code>
	 *
	 * @param mixed $st The item to be tested.
   ...
   *
   * <code>
   * \bbn\txt::is_decimal(13.2); //Returns true
   * \bbn\txt::is_decimal('13.2'); //Returns true
   * \bbn\txt::is_decimal(14); //Returns false
   * </code>
   *
   * @param mixed $st The item to be tested.
   *
   ...
   *
   * <code>
   * \bbn\txt::correct_types('1230'); //Returns 1230
   * \bbn\txt::correct_types(12.30); //Returns 12.3
   * \bbn\txt::correct_types([1230]); //Returns [1230]
   * </code>
   *
   * @param string $st The string.
   ...
   *
   * <code>
   * \bbn\txt::is_email('test@email.com'); //Returns true
   * \bbn\txt::is_email('test@email'); //Returns false
   * \bbn\txt::is_email('test@.com'); //Returns false
   * \bbn\txt::is_email('testemail.com'); //Returns false
   * </code>
   *
   ...
   *
   * <code>
   * \bbn\txt::parse_url('http://localhost/phpmyadmin/?db=test&table=users&server=1&target=&token=e45a102c5672b2b4fe84ae75d9148981');
   * /*Returns [
   *     'scheme' => 'http',
   *     'host' => 'localhost',
   *     'path' => '/phpmyadmin/',
   ...
   *
   * <code>
   * \bbn\txt::parse_path('C:\TedstDir\New\New folder'); //Returns "C:/TedstDir/New/New folder"
   * </code>
   *
   ...
   *
   * <code>
   * \bbn\txt::remove_accents("TÃ¨st FÃ¬lÃ¨ Ã²Ã¨Ã Ã¹"); //Returns "Test File oeau"
   * </code>
   *
   * @param string $st The string.
   *
	 ...
	 *
	 * <code>
	 * \bbn\txt::check_name("Paul"); //Returns true
	 * \bbn\txt::check_name("PÃ ul"); //Returns false
	 * </code>
	 *
	 * @return bool
	 */
	 ...
	 * <code>
	 * \bbn\txt::check_name("Paul"); //Returns true
	 * \bbn\txt::check_name("PA/ul"); //Returns false
	 * </code>
	 *
	 * @return bool
	 */
   ...
   *
   * <code>
   * \bbn\txt::has_slash("Paul"); //Returns false
   * \bbn\txt::has_slash("Paul/"); //Returns true
   * \bbn\txt::has_slash("Paul\\"); //Returns true
   * </code>
   *
   * @return bool
   ...
   *
   * <code>
   * \bbn\txt::get_numbers("test 13 example 24"); //Returns 1324
   * </code>
   *
   * @param string $st The string.
   *
