...
class ide
{
  ...
  private $project = '';
  private $repository_default = '';
  private $origin = '';

  /** @var bool|int $ide_path */
  private static $ide_path = false;
  /** @var bool|int $dev_path */
  private static $dev_path = false;
  /** @var bool|int $path_type */
  private static $path_type = false;
  /** @var bool|int $files_pref */
  //private static $files_pref = false;
  /** @var bool|int $permissions */
  private static $permissions = false;
  /** @var bool|string $current_file */
  private static $current_file = false;
  ...
  */
  ...
  public function set_recent_file(string $file): bool
  {
    ...
    //add bit
      ...
      if (!empty($id_pref) && $this->pref->add_bit(
        $id_pref,[
        //'id_option' => $id_link,
        'id_option' => null,
        'cfg' =>  json_encode($cfg),
