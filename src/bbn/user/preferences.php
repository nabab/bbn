...
class preferences extends bbn\models\cls\db
{
  ...
  {
    if (($id_option = $this->_get_id_option($id_option))
        && !$this->retrieve_user_ids($id_option)
   ...
   * @return null|string
   */
  public function add_to_group(string $id_option = null, array $cfg): ?string
  {
    if (($id_option = $this->_get_id_option($id_option))
        && $this->_insert($id_option, $cfg)
    ) {
